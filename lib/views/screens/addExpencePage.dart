...
class AddExpencePage extends StatefulWidget {
  @override
  State<AddExpencePage> createState() => _AddExpencePageState();
}
...
class _AddExpencePageState extends State<AddExpencePage> {
  ...
  Widget build(BuildContext context) {
    expensesValueController.text = '0';
              ...
              floatingActionButton: FloatingActionButton(
                ...
                onPressed: () {
                  ...
                  ExpensesModel expensesModel = ExpensesModel(
                      iconId: categoryProvider.selectedIconsId!,
                      name: categoryProvider.selectedName!,
                      value: double.parse(expensesValueController.text),
                      time: expensesProvider.dateMiliseconds,
                      isExpenses: categoryProvider.isExpenses!);
                  expensesProvider.addNewExpenses(expensesModel);
                  categoryProvider.resetSelectedCategory();
                  expensesProvider.resetDate();
